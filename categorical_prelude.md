...
| <img src="/andrew-johnson-4/perplexity/raw/main/img/orange_line.png" style="height:1em;"/> | ∀ A,B. A->B = B->A | ∀ a,b. a(b) = b(a) | = | Equations are the natural units of Split Categories. Categorical "Equations" more specifically refer to either Equalisers or Coequalisers.
