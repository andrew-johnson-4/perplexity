...
| <img src="/img/purple_line.png" style="height:1em;"/> | TermTransformation | β-reduction | (λx.t)(u) → βt[u/x]	 | Replacing bound variables with the argument expression in the body of the abstraction is the basis of Up Categories. Beta-Reduction is exclusively allowed to change type signatures of terms to account for things like polymorphism.
