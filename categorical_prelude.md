...
| <img src="/img/pink_line.png" style="height:1em;"/> | TypeReduction | \|\| | $$ \pi_1(s:\sigma,t:\tau) = s:\sigma $$ $$ \pi_2(s:\sigma,t:\tau) = t:\tau $$ $$ (\pi_1(u:\sigma \times \tau),\pi_2(u:\sigma \times \tau)) = u:\sigma \times \tau $$ $$ t:1 = () $$ | The Type system should be strongly normalizing. Type unification and reduction is the basis of Parallel Categories.
